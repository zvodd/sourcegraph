...
describe('scanSearchQuery() for literal search', () => {
    ...
    test('filter', () =>
        expect(scanSearchQuery('f:b')).toMatchInlineSnapshot(
            '{"type":"success","term":[{"type":"field","range":{"start":0,"end":1},"value":"f","negated":false},{"type":"separator","range":{"start":1,"end":2}},{"type":"literal","value":"b","range":{"start":2,"end":3},"quoted":false}]}'
        ))

    test('negated filter', () =>
        expect(scanSearchQuery('-f:b')).toMatchInlineSnapshot(
            '{"type":"success","term":[{"type":"field","range":{"start":0,"end":2},"value":"-f","negated":true},{"type":"separator","range":{"start":2,"end":3}},{"type":"literal","value":"b","range":{"start":3,"end":4},"quoted":false}]}'
        ))

    test('filter with quoted value', () => {
        expect(scanSearchQuery('f:"b"')).toMatchInlineSnapshot(
            '{"type":"success","term":[{"type":"field","range":{"start":0,"end":1},"value":"f","negated":false},{"type":"separator","range":{"start":1,"end":2}},{"type":"literal","value":"b","range":{"start":2,"end":5},"quoted":true}]}'
        )
    })

    test('filter with a value ending with a colon', () => {
        expect(scanSearchQuery('f:a:')).toMatchInlineSnapshot(
            '{"type":"success","term":[{"type":"field","range":{"start":0,"end":1},"value":"f","negated":false},{"type":"separator","range":{"start":1,"end":2}},{"type":"literal","value":"a:","range":{"start":2,"end":4},"quoted":false}]}'
        )
    })
    ...
    test('do not treat links as filters', () => {
        expect(scanSearchQuery('http://example.com repo:a')).toMatchInlineSnapshot(
            '{"type":"success","term":[{"type":"pattern","range":{"start":0,"end":18},"kind":1,"value":"http://example.com"},{"type":"whitespace","range":{"start":18,"end":19}},{"type":"field","range":{"start":19,"end":23},"value":"repo","negated":false},{"type":"separator","range":{"start":23,"end":24}},{"type":"literal","value":"a","range":{"start":24,"end":25},"quoted":false}]}'
        )
    })
})
...
describe('scanSearchQuery() for regexp', () => {
    ...
    test('interpret regexp slash quotes', () => {
        expect(scanSearchQuery('r:a /a regexp \\ pattern/', false, SearchPatternType.regexp)).toMatchInlineSnapshot(
            '{"type":"success","term":[{"type":"field","range":{"start":0,"end":1},"value":"r","negated":false},{"type":"separator","range":{"start":1,"end":2}},{"type":"literal","value":"a","range":{"start":2,"end":3},"quoted":false},{"type":"whitespace","range":{"start":3,"end":4}},{"type":"literal","value":"a regexp \\\\ pattern","range":{"start":4,"end":24},"quoted":true}]}'
        )
    })
})
...
describe('scanSearchQuery() with predicate', () => {
    test('recognize predicate', () => {
        expect(scanSearchQuery('repo:contains(file:README.md)')).toMatchInlineSnapshot(
            '{"type":"success","term":[{"type":"field","range":{"start":0,"end":4},"value":"repo","negated":false},{"type":"separator","range":{"start":4,"end":5}},{"type":"literal","value":"contains(file:README.md)","range":{"start":5,"end":29},"quoted":false}]}'
        )
    })
    ...
    test('recognize multiple predicates over whitespace', () => {
        expect(scanSearchQuery('repo:contains(file:README.md)\n\nrepo:contains.file(foo)')).toMatchInlineSnapshot(
            '{"type":"success","term":[{"type":"field","range":{"start":0,"end":4},"value":"repo","negated":false},{"type":"separator","range":{"start":4,"end":5}},{"type":"literal","value":"contains(file:README.md)","range":{"start":5,"end":29},"quoted":false},{"type":"whitespace","range":{"start":29,"end":31}},{"type":"field","range":{"start":31,"end":35},"value":"repo","negated":false},{"type":"separator","range":{"start":35,"end":36}},{"type":"literal","value":"contains.file(foo)","range":{"start":36,"end":54},"quoted":false}]}'
        )
    })
})
