...
var $author$project$Main$Chart = {$: 'Chart'};
var $author$project$Main$RunCompute = {$: 'RunCompute'};
var $elm$core$Dict$RBEmpty_elm_builtin = {$: 'RBEmpty_elm_builtin'};
var $elm$core$Dict$empty = $elm$core$Dict$RBEmpty_elm_builtin;
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{dataPoints: 30, excludeStopWords: false, millisSinceChange: 0, query: 'repo:sourcegraph$ content:output((.|\\n)*codeintel(.|\\n)* -> $author) type:commit count:all', queryModifiedSinceLastRequest: false, resultsMap: $elm$core$Dict$empty, resultsRaw: _List_Nil, reverse: false, selectedTab: $author$project$Main$Chart, serverless: false, sortByCount: true},
		A2(
			$elm$core$Task$perform,
			$elm$core$Basics$identity,
			$elm$core$Task$succeed($author$project$Main$RunCompute)));
};
var $author$project$Main$CheckTick = function (a) {
	return {$: 'CheckTick', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $author$project$Main$delayCheckTick = 200;
var $author$project$Main$NoOp = {$: 'NoOp'};
var $author$project$Main$OnResults = function (a) {
	return {$: 'OnResults', a: a};
};
var $author$project$Main$ResultStreamDone = {$: 'ResultStreamDone'};
...
var $author$project$Main$resultEventDecoder = function (input) {
	var _v0 = A2(
...
var $author$project$Main$eventDecoder = function (event) {
	var _v0 = event.eventType;
	if (_v0.$ === 'Just') {
		switch (_v0.a) {
			case 'results':
				return $author$project$Main$OnResults(
					$author$project$Main$resultEventDecoder(event.data));
			case 'done':
				var _v1 = $elm$core$Debug$log('saw done event');
				return $author$project$Main$ResultStreamDone;
			default:
				var e = _v0.a;
...
var $author$project$Main$receiveEvent = _Platform_incomingPort(
	'receiveEvent',
	A2(
		$elm$json$Json$Decode$andThen,
		function (id) {
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$receiveEvent($author$project$Main$eventDecoder),
				A2($elm$time$Time$every, $author$project$Main$delayCheckTick, $author$project$Main$CheckTick),
				$elm$browser$Browser$Events$onKeyDown($author$project$Main$keyDecoder)
			]));
};
var $author$project$Main$UpdateTick = function (a) {
	return {$: 'UpdateTick', a: a};
};
...
var $author$project$Main$delayComputeRequest = 400;
var $author$project$Main$endpoint = 'https://sourcegraph.test:3443/.api';
var $author$project$Main$exampleResultsMap = $elm$core$Dict$fromList(
	A2(
		$elm$core$List$map,
		function (d) {
...
var $author$project$Main$openStream = _Platform_outgoingPort(
	'openStream',
	function ($) {
		var a = $.a;
		var b = $.b;
	...
	function (textResult, d) {
		return A3(
			...
			function (v) {
				if (v.$ === 'Nothing') {
					return $elm$core$Maybe$Just(
						$author$project$Main$newDataValue(textResult));
				} else {
					var existing = v.a;
					return $elm$core$Maybe$Just(
						_Utils_update(
			...
			switch (msg.$) {
				case 'OnQueryChanged':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{query: newQuery, queryModifiedSinceLastRequest: true}),
						A2($elm$core$Task$perform, $author$project$Main$UpdateTick, $elm$time$Time$now));
				...
				case 'UpdateTick':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								millisSinceChange: $elm$time$Time$posixToMillis(time)
							}),
						$elm$core$Platform$Cmd$none);
				case 'CheckTick':
					var time = msg.a;
				...
				case 'RunCompute':
					...
					return model.serverless ? _Utils_Tuple2(
						...
						$author$project$Main$openStream(
							_Utils_Tuple2(
								_Utils_ap(
									$author$project$Main$endpoint,
									A2(
...
var $author$project$Main$dataView = function (data) {
	return A2(
...
var $author$project$Main$filterData = F2(
	function (_v0, data) {
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$terezka$elm_charts$Chart$Attributes$moveDown(12),
											...
											return A2(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$svg$Svg$Attributes$xlinkHref('https://elm-lang.org')
															]),
														_List_fromArray(
															[
																A2(
...
var $author$project$Main$OnDataPoints = function (a) {
	return {$: 'OnDataPoints', a: a};
};
var $author$project$Main$OnExcludeStopWordsCheckbox = function (a) {
	return {$: 'OnExcludeStopWordsCheckbox', a: a};
};
var $author$project$Main$OnQueryChanged = function (a) {
	return {$: 'OnQueryChanged', a: a};
};
var $author$project$Main$OnReverseCheckbox = function (a) {
	return {$: 'OnReverseCheckbox', a: a};
};
var $author$project$Main$OnSortByCheckbox = function (a) {
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								label: $mdgriffith$elm_ui$Element$Input$labelHidden(''),
								onChange: $author$project$Main$OnDataPoints,
								placeholder: $elm$core$Maybe$Nothing,
								text: function () {
								...
								]),
							{
								...
								onChange: $author$project$Main$OnSortByCheckbox
							}),
							A2(
							$mdgriffith$elm_ui$Element$Input$checkbox,
							_List_fromArray(
								...
								]),
							{
								...
								onChange: $author$project$Main$OnReverseCheckbox
							}),
							A2(
							$mdgriffith$elm_ui$Element$Input$checkbox,
							_List_fromArray(
								...
								]),
							{
								...
								onChange: $author$project$Main$OnExcludeStopWordsCheckbox
							})
						]))
				])));
};
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Main$Data = {$: 'Data'};
...
var $author$project$Main$color = {
	...
	vividViolet: A3($mdgriffith$elm_ui$Element$rgb255, 161, 18, 255)
};
...
var $author$project$Main$tab = F2(
	function (thisTab, selectedTab) {
		...
		var tabColor = function () {
			switch (selectedTab.$) {
				case 'Chart':
					return $author$project$Main$color.vividViolet;
				case 'Table':
					return $author$project$Main$color.vermillion;
				default:
					return $author$project$Main$color.skyBlue;
			}
		}();
...
var $author$project$Main$outputRow = function (selectedTab) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Main$tab, $author$project$Main$Table, selectedTab),
				A2($author$project$Main$tab, $author$project$Main$Data, selectedTab)
			]));
};
...
var $author$project$Main$table = function (data) {
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Main$outputRow(model.selectedTab),
							function () {
							var _v0 = model.selectedTab;
							switch (_v0.$) {
								case 'Chart':
									return $author$project$Main$histogram(
										A2(
											$author$project$Main$filterData,
											model,
											A2(
												$elm$core$List$map,
								...
								case 'Table':
									return $author$project$Main$table(
										A2(
											$author$project$Main$filterData,
											model,
											A2(
												...
												$elm$core$Dict$toList(model.resultsMap))));
								default:
									return $author$project$Main$dataView(
										A2(
											$author$project$Main$filterData,
											model,
											A2(
...
*/
export const App = {'Main':{'init':$author$project$Main$main(
