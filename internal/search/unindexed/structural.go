...
func streamStructuralSearch(ctx context.Context, args *search.SearcherParameters, repos *search.Repos, stream streaming.Sender) (err error) {
	...
	if len(repos.IndexedRepoRevs) != 0 {
		jobs = append(jobs, &searchRepos{args: searcherArgs, stream: stream, repoSet: repos, indexed: true})
	}

	if len(repos.UnindexedRepoRevs) != 0 {
		jobs = append(jobs, &searchRepos{args: searcherArgs, stream: stream, repoSet: repos, indexed: false})
	}
...
func retryStructuralSearch(ctx context.Context, args *search.SearcherParameters, repos *search.Repos, stream streaming.Sender) error {
...
func runStructuralSearch(ctx context.Context, args *search.SearcherParameters, repos *search.Repos, stream streaming.Sender) error {
...
func (s *StructuralSearch) Run(ctx context.Context, stream streaming.Sender) error {
	return runStructuralSearch(ctx, &s.SearcherArgs, s.Repos, stream)
}
