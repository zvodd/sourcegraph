		...
		return _Utils_Tuple2(
			{
				...
				reverse: false,
				selectedTab: $author$project$Main$Chart,
				serverless: false,
				sortByCount: true
			},
			A2(
...
var $author$project$Main$onUrlChange = function (url) {
	return $author$project$Main$OnUrlChange(url);
};
			...
			switch (msg.$) {
				...
				case 'CheckTick':
					...
					return ((_Utils_cmp(
						...
						$author$project$Main$delayComputeRequest) > 0) && model.queryModifiedSinceLastRequest) ? _Utils_Tuple2(
						model,
						A2(
