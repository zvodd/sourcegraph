...
export interface Settings {
   ...
   */
  "codeIntelligence.maxPanelResults"?: number;
  /**
...
export interface SettingsExperimentalFeatures {
  ...
  /**
   * DEPRECATED: Enables gql api instead of using setting cascade as a main storage fro code insights entities
   */
  ...
  /**
   * Enables query based search contexts
   */
  ...
  /**
   * Enables search stack
   */
  enableSearchStack?: boolean;
  /**
