...
type ZoektRepoUniverseSearch struct {
...
func (t *ZoektRepoUniverseSearch) Run(ctx context.Context, db database.DB, stream streaming.Sender) (_ *search.Alert, err error) {
...
func (*ZoektRepoUniverseSearch) Name() string {
	return "ZoektRepoUniverse"
}
