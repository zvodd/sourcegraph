...
func (s *Store) WriteMeta(ctx context.Context, bundleID int, meta precise.MetaData) (err error) {
	ctx, endObservation := s.operations.writeMeta.With(ctx, &err, obsv.Args{LogFields: []obsv.Field{
...
func (s *Store) WriteDocuments(ctx context.Context, bundleID int, documents chan precise.KeyedDocumentData) (count uint32, err error) {
	ctx, traceLog, endObservation := s.operations.writeDocuments.WithAndLogger(ctx, &err, obsv.Args{LogFields: []obsv.Field{
		obsv.Int("bundleID", bundleID),
	}})
	defer endObservation(1, obsv.Args{})
	...
	traceLog(obsv.Int("numDocumentRecords", int(count)))
...
func (s *Store) WriteResultChunks(ctx context.Context, bundleID int, resultChunks chan precise.IndexedResultChunkData) (count uint32, err error) {
	ctx, traceLog, endObservation := s.operations.writeResultChunks.WithAndLogger(ctx, &err, obsv.Args{LogFields: []obsv.Field{
		obsv.Int("bundleID", bundleID),
	}})
	defer endObservation(1, obsv.Args{})
...
func (s *Store) WriteDefinitions(ctx context.Context, bundleID int, monikerLocations chan precise.MonikerLocations) (count uint32, err error) {
	ctx, traceLog, endObservation := s.operations.writeDefinitions.WithAndLogger(ctx, &err, obsv.Args{LogFields: []obsv.Field{
		obsv.Int("bundleID", bundleID),
	}})
	defer endObservation(1, obsv.Args{})
...
func (s *Store) WriteReferences(ctx context.Context, bundleID int, monikerLocations chan precise.MonikerLocations) (count uint32, err error) {
	ctx, traceLog, endObservation := s.operations.writeReferences.WithAndLogger(ctx, &err, obsv.Args{LogFields: []obsv.Field{
		obsv.Int("bundleID", bundleID),
	}})
	defer endObservation(1, obsv.Args{})
...
func (s *Store) WriteImplementations(ctx context.Context, bundleID int, monikerLocations chan precise.MonikerLocations) (count uint32, err error) {
	ctx, traceLog, endObservation := s.operations.writeImplementations.WithAndLogger(ctx, &err, obsv.Args{LogFields: []obsv.Field{
		obsv.Int("bundleID", bundleID),
	}})
	defer endObservation(1, obsv.Args{})
...
func (s *Store) writeMonikers(ctx context.Context, bundleID int, tableName string, version int, monikerLocations chan precise.MonikerLocations, traceLog obsv.TraceLogger) (count uint32, err error) {
	tx, err := s.Transact(ctx)
	if err != nil {
		return 0, err
	}
