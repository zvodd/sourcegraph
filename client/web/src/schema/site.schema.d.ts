...
export interface SiteConfiguration {
  ...
  experimentalFeatures?: {
    ...
    /**
     * Allow adding NPM packages code host connections
     */
    ...
    ranking?: {
      ...
      /**
       * The maximum number of search results that can be buffered to sort results. -1 is unbounded. The default is 24. Set this to small integers to limit latency increases from slow backends.
       */
      maxReorderQueueSize?: number;
      [k: string]: unknown;
    };
    /**
     * Enable support for visilibity of internal Github repositories
     */
  ...
  dotcom?: {
    ...
    /**
     * The config options for Sourcegraph Cloud GitHub App.
     */
    "githubApp.cloud"?: {
      /**
       * The app ID of the GitHub App for Sourcegraph Cloud.
       */
      appID?: string;
      /**
       * The base64-encoded private key of the GitHub App for Sourcegraph Cloud.
       */
      privateKey?: string;
      [k: string]: unknown;
    };
