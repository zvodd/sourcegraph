...
import React, { FunctionComponent, useState, FormEventHandler, useCallback, useMemo } from 'react'
...
export const FormTriggerArea: FunctionComponent<TriggerAreaProps> = ({
    query,
    onQueryChange,
    triggerCompleted,
    setTriggerCompleted,
